    ...
    <FlexColumn width="100%">
      <div className={styles.header}>
        ...
        <div className={styles.navigation}>
          ...
          <div className={styles.leftnav}><Link className={styles.underlined} to="/login">Login</Link></div>   <div className={styles.rightnav}><a href="/">About Us</a><a href="/">Tours</a><a href="/">Contacts</a></div>
          </div>
...
<div className={styles.footer}>
  ...
  <div className={styles.footercenter}><h4>Contacts</h4>
